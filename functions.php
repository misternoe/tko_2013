...
URL: htp://www.tkoadvertising.com
...
Removing the auto <p> tags from around images or inside the content.
EDIT: wp-includes/default-filters.php
COMMENT OUT: add_filter( 'the_content', 'wpautop' );
...
*/
// require_once('library/custom-post-type-team.php'); // you can disable this if you like
require_once('library/post-type/custom-post-type-team/custom-post-type-team.php'); // you can disable this if you like
// require_once('library/custom-post-type-team.php'); // you can disable this if you like
require_once('library/post-type/custom-post-type-portfolio/custom-post-type-portfolio.php'); // you can disable this if you like
...
/* -----------------------------------------------------------------------------------------
	...
	CUSTOM VISUAL EDITOR CLASSES

----------------------------------------------------------------------------------------- */
function custom_mce_styles( $init ) {
    $init['theme_advanced_buttons2_add_before'] = 'styleselect';
	// Edit Below:
    $init['theme_advanced_styles'] = 'One Column=col-1, Two Column=col-2, Three Column=col-3, Two Column=col-2, No Shadow=noshadow, Full Width=site-row';
    return $init;
}
