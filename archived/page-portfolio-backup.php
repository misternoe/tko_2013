...
<?php get_header(); ?>
    ...
    ?>  
        <?php   
        $loop = new WP_Query(array('orderby' => 'date', 'order' => 'DESC', 'posts_per_page' => 32, 'paged' => $paged, 'post_type' => 'project' ));  
        $count =0;  
        ...
        <ul id="portfolio-list">
            <?php if ( $loop ) :   
                while ( $loop->have_posts() ) : $loop->the_post(); ?>        
                    ...
                    <li class="portfolio-item <?php echo( basename(get_permalink()) );?> <?php echo strtolower($tax); ?> all" onclick="window.location='<?php the_permalink() ?>'">
