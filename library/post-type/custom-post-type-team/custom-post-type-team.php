...
class TeamProfiles
{
	...
	public function load_styles() {
		if ( is_page_template('page-team.php') ) // Detect which page template is used for CSS
	   	wp_enqueue_style( 'team-template', get_stylesheet_directory_uri() . '/library/post-type/custom-post-type-team/team.css' );
	}
